...
const SavedComicPlaylistsPage = () => {
  ...
  const router = useRouter();
    ...
    const {data: paginatedData, isLoading} = useGetPlaylistsPagination({
        ...
        savedByUserId: userId as Id<"users">,
    });
    ...
    const playlists = (paginatedData?.playlistsInfo ?? []).map((pl) => ({
     ...
     const handlePageChange = (page: number) => {
      ...
      router.push(`/user/${userId}/savedComicLists?${params.toString()}`);
    };
...
export default SavedComicPlaylistsPage