...
const popularByCategory = () => {
  return (
    ...
    // <div className=' px-[60px] md:px-[320px] py-1 md:py-8 flex flex-col w-full h-[700px] '>
    //     <p className='text-foreground text-l md:text-2xl text-left'>Popular by category</p>
    //     <div className='grid  grid-cols-4 md:grid-cols-10 gap-2 my-4'>
    //         <GenreButton  variant="active" genre={genres[0]}/>
    //         {genres.map((genre) => (
    //             genre !== genres[0] && <GenreButton key={genre} variant="not-active" genre={genre}/>
    //         ))}
